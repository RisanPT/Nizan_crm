...
class _FinancialGlossaryScreenState extends ConsumerState<FinancialGlossaryScreen> {
  ...
  static final List<_Term> _terms = [
    ...
    _Term('Free Cash Flow', 'Cash left after operating costs — available to reinvest or distribute. Approximated here by net cash flow.', (r) => _money(r.cashNet)),
    ...
    _Term('Capital Expenditure (CAPEX)', 'Spend on long-term assets like equipment — capitalised, not expensed.', null),
    ...
    _Term('Inventory Turnover', 'How many times stock is sold and replaced in a period.', null),
    _Term('Days Sales Outstanding (DSO)', 'Average days to collect payment after a sale.', null),
    _Term('Days Payable Outstanding (DPO)', 'Average days you take to pay suppliers.', null),
    _Term('Debt-to-Equity Ratio', 'Total debt relative to owner equity — financial leverage.', null),
