            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text('GST INVOICE — ORIGINAL COPY', style: theme.textTheme.bodySmall?.copyWith(letterSpacing: 1, color: Colors.grey.shade700)),
                ],
              ),
              24.h,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('YOUR ARTIST', style: theme.textTheme.bodySmall?.copyWith(fontWeight: FontWeight.bold, color: Colors.grey.shade600, letterSpacing: 1)),
                          12.h,
                          if (b.assignedStaff.isNotEmpty) ...[
                            _pdfInfoRow('Artist', b.assignedStaff.first.artistName, theme),
                            _pdfInfoRow('Role', b.assignedStaff.first.roleType, theme),
                            if (b.assignedStaff.first.phone.isNotEmpty) _pdfInfoRow('Contact', b.assignedStaff.first.phone, theme),
                          ],
                          if (b.pocName.isNotEmpty) _pdfInfoRow('POC', '${b.pocName} — ${b.pocPhone}', theme),
                          _pdfInfoRow('Slot', b.bookingItems.isNotEmpty ? b.bookingItems.first.eventSlot : '-', theme),
                        ],
                      ),
                    ),
                  ),
