            ...
            if (c.attachmentUrl != null) ...[
              ...
              GestureDetector(
                onTap: () {
                  ...
                  showDialog(
                    context: context,
                    builder: (_) => _CollectionImageViewerDialog(
                      url: c.attachmentUrl!,
                    ),
                  );
                },
...
// ─────────────────────────────────────────────────────────────────────────────
//  Full-screen Image Viewer with Download & Share (Collections)
// ─────────────────────────────────────────────────────────────────────────────
class _CollectionImageViewerDialog extends StatefulWidget {
  final String url;
  final bool autoShare;
  final bool autoDownload;

  const _CollectionImageViewerDialog({
    required this.url,
  ...
  @override
  State<_CollectionImageViewerDialog> createState() =>
      _CollectionImageViewerDialogState();
}

class _CollectionImageViewerDialogState
    extends State<_CollectionImageViewerDialog> {
  bool _isBusy = false;
